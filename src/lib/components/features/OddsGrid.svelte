...
<div class="relative overflow-hidden rounded-xl bg-[#12141a]" style="border:1px solid rgba(255,255,255,0.07);">
	<!-- Ambient glow -->
	<div class="pointer-events-none absolute inset-0">
		<div class="absolute top-0 left-1/4 w-72 h-40 rounded-full blur-3xl opacity-60"
			style="background: radial-gradient(circle, rgba(245,200,66,0.07) 0%, transparent 70%)"></div>
		<div class="absolute bottom-0 right-1/4 w-52 h-36 rounded-full blur-2xl opacity-50"
			style="background: radial-gradient(circle, rgba(74,158,255,0.07) 0%, transparent 70%)"></div>
	</div>
	...
	<div class="relative flex items-center justify-between px-5 pt-4">
		...
		<span class="text-[11px] font-semibold tracking-[1px] uppercase flex items-center gap-1.5"
			style="color:#f5c842;">
	...
	<div class="relative flex items-center justify-between px-6 sm:px-10 py-6 gap-4">
		...
		<div class="flex flex-col items-center gap-1 shrink-0">
			<span class="font-display text-[38px] leading-none tracking-[2px]"
				style="color:rgba(255,255,255,0.1);">VS</span>
			<span class="font-mono text-[11px] font-semibold tracking-[1px]" style="color:#f5c842;">
