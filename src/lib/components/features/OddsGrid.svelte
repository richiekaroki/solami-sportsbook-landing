<script lang="ts">
	...
	function updateCountdown() {
		countdownText = formatCountdown(game.start_time);
	}
...
>
	...
	<div class="relative flex items-center justify-between px-5 pt-4 pb-0">
		...
		<div class="flex items-center gap-2">
			<span
				class="text-[9px] font-bold tracking-[0.8px] uppercase px-2 py-0.5 rounded-full flex items-center gap-1"
			...
			<span
				class="text-[10px] font-semibold tracking-[0.8px] uppercase flex items-center gap-1"
	...
	<div class="relative flex items-center justify-between px-6 sm:px-10 py-6 gap-4">
		<div class="flex flex-col items-center gap-3 flex-1 min-w-0">
			...
			<span
				class="text-[14px] sm:text-[15px] font-semibold text-center leading-tight truncate w-full"
		...
		<div class="flex flex-col items-center gap-2 shrink-0">
			...
			<div class="flex flex-col items-center gap-0.5">
				...
				<span class="font-mono text-[14px] font-bold" style="color:var(--color-gold);"
					>{countdownText}</span
				>
			</div>
		</div>
	...
	<!-- Bonus ribbon -->
	<div
		class="relative flex items-center gap-2 px-5 py-2.5 mx-0"
